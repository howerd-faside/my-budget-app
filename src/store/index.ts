...
export type { FinanceStoreState,    FinanceStoreActions,    FinanceStore }    from './financeStore';
export type { PeopleStoreState,     PeopleStoreActions,     PeopleStore }     from './peopleStore';
export type { PropertyStoreState,   PropertyStoreActions,   PropertyStore }   from './propertyStore';
export type { InvestmentStoreState, InvestmentStoreActions, InvestmentStore } from './investmentStore';
export type { UiStoreState, UiStore }                                        from './uiStore';
