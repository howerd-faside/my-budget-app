...
export const EXPENSE_GROUPS = [
  ...
  { id: 'transport', label: 'Transport',    icon: '🚗', color: '#30d158',
    cats: ['Vehicle Loan', 'Fuel', 'Vehicle Insurance', 'WOF & Rego', 'Public Transport', 'Parking'] },
  ...
  { id: 'insurance', label: 'Insurance',    icon: '🔐', color: '#ffd60a',
    cats: ['Health Insurance', 'Life Insurance', 'House Insurance', 'Contents Insurance', 'Income Protection'] },
